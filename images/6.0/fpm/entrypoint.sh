...
EOF
	...
	if [ ${DOLI_AUTO_INSTALL} -eq 1 ]; then
		echo "Dolibarr auto install is not yet supported."

		#echo "Dolibarr auto install to $image_version..."

		# Install with PHP? Does not work simply because install is hardwired to HTTP post methods... (for now)
