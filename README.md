...
-   Dolibarr 10
    ...
    -   [`10.0-fpm` `fpm`: /images/10.0/php7.2-fpm](/images/10.0/php7.2-fpm/Dockerfile)
    -   [`10.0-alpine` `alpine`: /images/10.0/php7.2-alpine](/images/10.0/php7.2-alpine/Dockerfile)
-   Dolibarr 9.0
